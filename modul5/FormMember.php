  ...
  <body>
    <div class="container">
      ...
      <div class="form-container">
        <form method="post" action="" autocomplete="off">
          ...
          <input type="datetime-local" name="tgl_mendaftar" id="tgl_mendaftar" value="<?php echo isset($member['tgl_mendaftar']) ? $member['tgl_mendaftar'] : $currentDateTime; ?>" required><br>

          <label for="tgl_terakhir_bayar">Tanggal Terakhir Bayar</label>
          <input type="date" name="tgl_terakhir_bayar" id="tgl_terakhir_bayar" placeholder="YYYY-MM-DD" value="<?php echo isset($member['tgl_terakhir_bayar']) ? $member['tgl_terakhir_bayar'] : ''; ?>" required><br>
    ...
    <a href="Member.php" class="back-link">← Kembali ke Member</a>
  </body>
